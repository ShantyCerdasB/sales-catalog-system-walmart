      ...
      <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div className="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between p-4 space-y-3 md:space-y-0 md:space-x-4">
            ...
            <button
              onClick={onAdd}
              className="flex items-center bg-primary-700 hover:bg-primary-800 text-white px-4 py-2 rounded-lg text-sm font-medium focus:ring-4 focus:ring-primary-300"
            >
